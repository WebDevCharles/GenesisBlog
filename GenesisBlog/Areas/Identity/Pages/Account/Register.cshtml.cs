...
namespace GenesisBlog.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            /// 
            // The next two code sections are custom and enable the page to collect data for the given fields
            [Required]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Here we can work in the additional data provided by the User.
                // This is customer and hands off the user supplied First and Last names
